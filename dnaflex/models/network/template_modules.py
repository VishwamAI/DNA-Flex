...
from dnaflex.jax import geometry
from dnaflex.models import features
from dnaflex.models import model_config
from dnaflex.models import dna_data_processing
from dnaflex.models.components import haiku_modules as hm
from dnaflex.models.network import modules
from dnaflex.models.scoring import scoring
import haiku as hk
import jax
  ...
  def __call__(
    ...
    def construct_input(
      ...
      template_group_indices = jnp.take(
          dna_data_processing.RESTYPE_RIGIDGROUP_DENSE_ATOM_IDX,
          templates.aatype,
          axis=0,
      )
